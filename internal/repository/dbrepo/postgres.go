...
// SearchAvailabilityForAllRooms returns a slice of availible rooms if any for given date range
...
func (m *postgresDBRepo) UpdateUser(u models.User) error {
	...
	defer cancel()
	query := `
		update users u set first_name = $1, last_name = $2, email = $3, access_level = $4, updated_at = $5
		`
...
// AllReservations resturns a slice of all reservations
...
// AllNewReservations resturns a slice of all reservations
...
// DeleteReservation deletes one reservation in the database by id
...
// GetRestrictionsForRoomByDate returbs restriction for a room by date range
