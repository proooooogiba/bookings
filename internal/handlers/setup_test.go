...
func TestMain(m *testing.M) {
	...
	tc, err := СreateTestTemplateCache()
	if err != nil {
...
// СreateTestTemplateCache creates a template cache as a map
func СreateTestTemplateCache() (map[string]*template.Template, error) {
